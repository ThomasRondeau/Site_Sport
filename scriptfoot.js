var bouton_foot = document.querySelector("#bouton_foot");
var feed1 = document.querySelector("#feed1_foot");
var feed2 = document.querySelector("#feed2_foot");
var cpt = 1;
bouton_foot.onclick = () => {
    if(cpt<4){
        fetch("registre.json")
        ...
        .then(function(data){
            ...
            newfeed1 = feed1;
            newfeed2 = feed2;
            newfeed1.href = data[2][cpt] ;
            cpt = cpt + 1;
            newfeed2.href = data[2][cpt];
            cpt = cpt + 1;
