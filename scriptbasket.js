var bouton_basket = document.querySelector("#bouton_basket");
var feed1 = document.querySelector("#feed1_basket");
var feed2 = document.querySelector("#feed2_basket");
var cpt = 1;
bouton_basket.onclick = () => {
    if(cpt<4){
        ...
        .then(function(data){
            ...
            newfeed1 = feed1;
            newfeed2 = feed2;
            newfeed1.href = data[0][cpt] ;
            cpt = cpt + 1;
            newfeed2.href = data[0][cpt];
            cpt = cpt + 1;
